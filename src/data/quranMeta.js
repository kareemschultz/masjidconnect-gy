...
export const juzData = [
  ...
  { number: 11, startSurah: 9, startAyah: 93, name: 'Ya\'tadhirun' },
  { number: 12, startSurah: 11, startAyah: 6, name: 'Wa Ma Min Dabbah' },
  ...
  { number: 16, startSurah: 18, startAyah: 75, name: 'Qal Alam' },
  ...
  { number: 20, startSurah: 27, startAyah: 56, name: 'Amman Khalaqa' },
  { number: 21, startSurah: 29, startAyah: 46, name: 'Utlu Ma Uhiya' },
  { number: 22, startSurah: 33, startAyah: 31, name: 'Wa Man Yaqnut' },
  { number: 23, startSurah: 36, startAyah: 28, name: 'Wa Mali' },
  { number: 24, startSurah: 39, startAyah: 32, name: 'Faman Azlamu' },
  { number: 25, startSurah: 41, startAyah: 47, name: 'Ilaihi Yuraddu' },
  { number: 26, startSurah: 46, startAyah: 1, name: 'Ha Mim' },
  { number: 27, startSurah: 51, startAyah: 31, name: 'Qala Fama Khatbukum' },
  { number: 28, startSurah: 58, startAyah: 1, name: 'Qad Sami\'a' },
...
export const reciters = [
  { id: 'ar.alafasy', name: 'Mishary Rashid Alafasy', subfolder: '128' },
  { id: 'ar.abdulbasit', name: 'Abdul Basit', subfolder: '192' },
  { id: 'ar.husary', name: 'Mahmoud Khalil Al-Husary', subfolder: '128' },
];
