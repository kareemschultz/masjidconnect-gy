    ...
    <>
      ...
      >
        <div className={`${containerClass} mx-auto flex items-stretch px-safe`}>
          {PRIMARY_NAV_ITEMS.map(tab => {
            ...
            return (
              <NavLink
                ...
                className={`flex-1 flex flex-col items-center justify-center gap-0.5 py-2 min-h-[44px] relative transition-all duration-200 focus-visible:outline-none ${
                  isActive
          ...
          >
            <span className={`flex items-center justify-center w-12 h-8 rounded-2xl transition-all duration-200 ${
              moreOpen || !isOnPrimaryTab ? 'bg-emerald-50 dark:bg-emerald-900/30' : ''
            }`}>
